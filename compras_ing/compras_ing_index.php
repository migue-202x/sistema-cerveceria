...
<?php
    ...
    $query = "SELECT ingredientes.* FROM ingredientes";
...
<html>
    <head>
        ...
        <script src="../compras_ing/js_compras_ing/funciones.js"></script>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body fondoGris">    
                        ...
                        <div  class="form-group">
                            ...
                            <select id="ingredientes_id" name="ingredientes_id" class="contenedor">
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body fondoGris">    
                        ...
                        <div  class="form-group">
                            <label>INGREDIENTES</label>
                            <select id="ingredientes_idu" name="ingredientes_idu" class="contenedor">
                                <option>Seleccionar</option>
                               <?php 
                                    foreach ($conn->query($query) as $row) { ?>
                                        <option value="<?php echo $row['id']; ?>"><?php echo $row['nombre']; ?></option>
...
//******************************************************
                     ...
                     cadena="ingredientes_id=" + ingredientes_id +
