<?php
   ...
   $stament = $conn->prepare('UPDATE ingredientes SET nombre=:nombre, proveedores_id=:proveedores_id, descripcion=:descripcion, stock_min=:stock_min, stock_actual=:stock_actual, costo=:costo, cantidad=:cantidad WHERE id=:id');
